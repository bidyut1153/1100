    ...
    <body>
        <div class="container">
            ...
            <section class="contact-info">
                ...
                <a href="mailto:webmaster@byobu.com" target="_blank" rel="noopener noreferrer" title="Click this link to contact the host" id="dynamicProviderLink">
                    webmaster@byobu.com
                </a>
            </section>
        ...
        <footer>
            <div class="container">
                <a href="https://cpanel.net/?utm_source=cpanelwhm&utm_medium=cplogo&utm_content=logolink&utm_campaign=cpanelwhmreferral" target="cpanel" title="cPanel, L.L.C.">
                    ...
                    <div class="copyright">Copyright © 2022 cPanel, L.L.C.</div>
                </a>
            </div>
        </footer>
    </body>
